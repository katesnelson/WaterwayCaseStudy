...
write.csv(sunriseset, "filename.csv", row.names=FALSE) #IMPORTANT!!! open the csv files and remove the quotes from the column headers or they will not pull up correctly in NetLogo